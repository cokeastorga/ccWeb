...
<div class="min-h-screen bg-gray-50 pt-10 pb-20 px-6 font-sans">
    ...
    <div class="max-w-6xl mx-auto mb-10 flex items-center justify-between">
        ...
        <a href="/ecommerce-v3" class="text-sm text-gray-500 hover:text-black transition-colors">
            ← Seguir comprando
        </a>
    </div>
    ...
    {#if $cart.length === 0}
        <div class="max-w-md mx-auto text-center py-20" in:fade>
            ...
            <a href="/ecommerce-v3" class="bg-black text-white px-8 py-3 rounded-full font-medium hover:bg-gray-800 transition-colors">
                Volver a la tienda
            </a>
        </div>
    {:else}
